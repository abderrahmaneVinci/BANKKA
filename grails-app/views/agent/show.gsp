...
<html>
	...
	<body>
		...
		<div id="show-agent" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:agentInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${agentInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
